 ...
 */
public abstract class BingMapAutoUpdatingBehavior extends AbstractDefaultAjaxBehavior {
     ...
     */
    public BingMapAutoUpdatingBehavior(final Duration updateInterval) {
	...
	protected void onBind() {
		...
		getBingMap().setOutputMarkupId(true);
	}
    ...
    protected final String getJsTimeoutCall(final Duration updateInterval) {
        return "window.BingmapAutoTimer = setTimeout(\"" + getCallbackScript() + "\", " + updateInterval.getMilliseconds() + ");";
    }
     ...
     *            The request target
     */
    protected abstract void onTimer(final AjaxRequestTarget target, BingMap map);
